...
const SpecialOffer = () => {
  return (
    ...
    <p className="mt-4 lg:max-w-lg info-text ">Embark on a shopping journey that redefines your experience with unbeatable deals. From premier selctions to incredible savings we offer unparalleled value that sets us apart</p>
